...
class LSPTest {
    ...
    @Test fun testCapabilities() {
        ...
        assertEquals(ErrorCode.ServerNotInitialized, server.handleRequest(Request(1, "test")).error!!.code)
        val result = server.handleRequest(Request(1, "initialize"))
        assertEquals(Capabilities(), result.result)
    }
