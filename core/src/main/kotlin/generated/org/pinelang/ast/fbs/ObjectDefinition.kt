...
class ObjectDefinition : Table() {
    ...
    fun children(j: Int) : org.pinelang.ast.fbs.ObjectDefinition? = children(org.pinelang.ast.fbs.ObjectDefinition(), j)
    fun children(obj: org.pinelang.ast.fbs.ObjectDefinition, j: Int) : org.pinelang.ast.fbs.ObjectDefinition? {
        val o = __offset(8)
        return if (o != 0) {
    ...
    fun signals(j: Int) : org.pinelang.ast.fbs.SignalExpr? = signals(org.pinelang.ast.fbs.SignalExpr(), j)
    ...
    fun props(j: Int) : org.pinelang.ast.fbs.PropDefinition? = props(org.pinelang.ast.fbs.PropDefinition(), j)
    fun props(obj: org.pinelang.ast.fbs.PropDefinition, j: Int) : org.pinelang.ast.fbs.PropDefinition? {
        val o = __offset(12)
        return if (o != 0) {
            obj.__assign(__indirect(__vector(o) + j * 4), bb)
        } else {
