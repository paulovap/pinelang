...
class SignalAssignment : Table() {
    ...
    companion object {
        ...
        fun createSignalAssignment(builder: FlatBufferBuilder, debugNameOffset: Int, id: UByte, exprOffset: Int) : Int {
        ...
        fun startSignalAssignment(builder: FlatBufferBuilder) = builder.startTable(3)
