package org.pinelang.android.compose
...
class PineVScroller(id: Int) : PineComposable(id) {
    companion object {
        val meta =
            PineMetaObject("VScroller") { PineVScroller(it) }
    }
...
class PineHScroller(id: Int) : PineComposable(id) {
    companion object {
        val meta =
            PineMetaObject("HScroller") { PineHScroller(it) }
    }
...
class PineRectangle(id: Int) : PineComposable(id) {
    companion object {
        val meta =
            PineMetaObject("Rectangle") { PineRectangle(it) }
    }
